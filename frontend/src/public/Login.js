...
const Login = ({isLoggedIn, setIsLoggedIn}) => {
  ...
  const handleSubmit = async (event) => {
    ...
    if (!name) {
      ...
      const userResponse = await fetch(`${baseURL}/account/login/${email}/${password}`);
          ...
          <div className="col-md-6">
            <div className="card">
              <div className="card-body">
                {success ? (
                  <>
                    <h3 className="card-title text-center">Login Successful</h3>
                    <h6 className="card-text text-center"> Make a deposit!</h6>
                    <button
